...
end_year1=2008
traces1 = pd.read_csv(
    f"./events_traces_catalog/{start_year1}_{end_year1}_picked_traces_p_arrival_abstime_labeled.csv"
)
...
end_year2=2019
traces2 = pd.read_csv(
    f"./events_traces_catalog/{start_year2}_{end_year2}_picked_traces_p_arrival_abstime_labeled.csv"
)
